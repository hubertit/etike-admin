  ...
  const mockMessages = [
    {
      ...
      subject: "Booking Confirmation - Gorilla Trekking",
      message: "Thank you for booking with us. Your gorilla trekking adventure is confirmed...",
      type: "email",
      status: "sent",
    ...
    },
    {
      ...
      message: "Your Lake Kivu relaxation trip is coming up in 3 days...",
      type: "email",
      status: "sent",
    ...
    },
    {
      ...
      subject: "Welcome to Etike Tours",
  ...
  const mockTemplates = [
    {
      ...
      content: "Thank you for choosing Etike Tours. Your booking details are...",
      category: "booking",
    },
    {
      id: "TEMP-002",
    ...
    },
    {
      ...
      subject: "Welcome to Etike Tours!",
      content: "Welcome to our tour family! We're here to make your Rwanda experience unforgettable...",
      category: "welcome",
    },
  ]
